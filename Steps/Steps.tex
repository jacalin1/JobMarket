...
\item \ifthenelse{\boolean{MyNotes}}{\marginpar{\tiny Ask computer
      ...
      secret from JMPO.}}{}  
  In mid-September, you need write a short memo about yourself for me and your advisor(s) that includes most of the facts you have entered into the database, as well as crucial extra content.  In this memo, \textit{briefly} describe
  ...
  quickly.  Also include visa status information.  \textit{This document
...
\item Prepare for the interviews; several students have provided
  detailed advice, which I have posted in \href{\urltree/Resources}{\texttt{Resources}}.  Also, the document
...
\together{
  \begin{center}
    ...
    \small
    \begin{tabular}{rl}
      Overall & \url{https://github.com/llorracc/JobMarket}
      ...
      % \\ FacGmail List      & \url{http://www.econ2.jhu.edu/jobmarket/information/gmail-accts.pdf}
      \\ Cover Letter & \url{http://www.econ2.jhu.edu/jobmarket/Information/CreateLabel\&CoverLetterInstruction.html}
      \\ ASSA meeting & \url{https://www.aeaweb.org/conference/}
      \\ \JOE & \url{https://www.aeaweb.org/joe/}
      \\ \JOE Signal & \url{https://www.aeaweb.org/joe/signal/}
      ...
      \\ EconJobMarket & \url{http://econjobmarket.org}
      % \\ Job Info & \url{http://www.illinoisskillsmatch.com/}
%      \\ Public Wiki & \url{http://bluwiki.com/go/Econjobmarket}
      % \\ Rankings & \url{https://github.com/llorracc/JobMarket/Resources/Rankings.doc}
      \\ Advice & \url{\urltree/Resources}
    \end{tabular}
  \end{center}}
\normalsize
